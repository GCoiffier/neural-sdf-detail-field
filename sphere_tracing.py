...
from src import load_model, renderers, MetaData
import torch
...
if __name__ == "__main__":
    ...
    parser.add_argument("folder", type=str, help="path to the model '.pt' file")
    ...
    SDF = load_model(metadata, args.folder, device)
